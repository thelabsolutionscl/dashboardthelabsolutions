...
test('CLIENTES conserva el command center visual y oculta el BASE CRM legacy en su vista canónica',()=>{
  ...
  assert.match(src,/function clientToolbar\(\)/,'Clientes conserva el command center visual inferior');
});
